        ...
        return <div className="border-end sidenav" id="sidebar-wrapper">
            ...
            <PerfectScrollbar className="sidebar-items">
                <ul className="list-unstyled ps-0">
                    ...
                    <li className="mb-1">
                        <Link tag="a" className="" to="/Hotel">
                        <i className="fa fa-text-width" aria-hidden="true"></i> Hotel
                        </Link>
                    </li>
                    <li className="mb-1">
                        <Link tag="a" className="" to="/Revenue">
                        <i className="fa fa-text-width" aria-hidden="true"></i> Revenue
                        </Link>
                    </li>
                    <li className="mb-1">
                        <Link tag="a" className="" to="/DeliveryAgent">
                        <i className="fa fa-text-width" aria-hidden="true"></i> Delivery Agent
                        </Link>
                    </li>
